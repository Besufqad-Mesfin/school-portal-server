...
import { addBook, updateBook, deleteBook, getBooks, searchBooks,sendGeneralAlerts,announceNewArrivals,sendDueDateReminder ,registerUser,borrowBook,returnBook,viewBorrowedBooks } from '../controllers/bookControllers.js'; // Import book controller
...
bookRoutes.post('/general-alert', authMiddleware, sendGeneralAlerts);
