...
import { addBook, updateBook,generateUsageReports,viewPopularBooks,viewFines,calculateFines,payFines, deleteBook, getBooks, searchBooks,sendGeneralAlerts,announceNewArrivals,sendDueDateReminder ,registerUser,borrowBook,returnBook,viewBorrowedBooks } from '../controllers/bookControllers.js'; // Import book controller
...
bookRoutes.get('/usage', authMiddleware,generateUsageReports);
bookRoutes.get('/popular-books', authMiddleware, viewPopularBooks);
